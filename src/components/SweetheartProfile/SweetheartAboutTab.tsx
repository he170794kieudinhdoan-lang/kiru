...
import { SweetheartProfileData } from '@/types/sweetheart';

interface SweetheartAboutTabProps {
  profile: SweetheartProfileData;
}

export const SweetheartAboutTab: React.FC<SweetheartAboutTabProps> = ({ profile }) => {
  return (
    <div className="neo-box p-4 sm:p-6 bg-white space-y-6">
      <div className="border-b-2 border-black pb-3">
        ...
        <p className="text-xs font-mono text-zinc-500">
          Thông tin chi tiết, học vấn, sở thích & kênh mạng xã hội chính thức
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 text-xs font-medium">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <span className="font-bold text-black">Tình trạng: </span>
          ...
          <div className="flex flex-wrap gap-2">
            <span className="neo-badge bg-black text-white flex items-center gap-1.5 cursor-pointer shadow-neo-sm">
              <span className="font-mono font-black text-xs">𝕏</span> X (Twitter): @tthaoisbaby
            </span>
            <span className="neo-badge bg-gradient-to-r from-purple-500 to-pink-500 text-white flex items-center gap-1.5 cursor-pointer shadow-neo-sm">
              <Camera className="w-3.5 h-3.5" /> Instagram: @tthaoisbaby
            </span>
            <span className="neo-badge bg-black text-white flex items-center gap-1.5 cursor-pointer shadow-neo-sm">
              <Music className="w-3.5 h-3.5" /> TikTok: @tthaobaby_official
            </span>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-zinc-50 border-2 border-black rounded-xl space-y-2 shadow-neo-sm">
            ...
            <p className="text-[11px] font-mono text-zinc-500">
              — Thảo Baby (Gen Z 2k5 • @tthaoisbaby)
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 text-center">
            ...
            <div className="p-2.5 bg-zinc-100 border-2 border-black rounded-lg">
              ...
              <div className="text-[10px] font-mono text-zinc-600">Hình ảnh HD</div>
            </div>
            <div className="p-2.5 bg-zinc-100 border-2 border-black rounded-lg">
              <div className="text-lg font-black font-kiru text-black">
                {profile.videoCount}
              </div>
              <div className="text-[10px] font-mono text-zinc-600">Video Reels</div>
            </div>
          </div>
        </div>
      </div>
